...
$(function() {
  ...
  var TITLES = [
    ['YUMEYUKI<br>JAPANESE SITE', 'detail/yumeyukijp.html'],
    ['YUMEYUKI<br>ENGLISH SITE', 'detail/yumeyukien.html'],
  ...
  var IMAGES = [
    ...
    ['02_yumeyukien.jpg', '02_yumeyukien.jpg'],
    ['03_yumeyukikr.jpg', '03_yumeyukikr.jpg'],
    ['04_holdblay.jpg', '04_holdblay.jpg'],
    ['05_ceramyanmar.jpg', '05_ceramyanmar.jpg'],
    ['06_thebridge.jpg', '06_thebridge.jpg'],
  ]
  var NGO_TITLES = [
    ['CERA<br>MYANMAR SITE', 'detail/cera.html'],
  ...
  var isNgoPage = window.location.href.includes('ngo-projects');

  // Set TITLES and IMAGES based on the page
  var TITLES = isNgoPage ? NGO_TITLES : TITLES;
  var IMAGES = isNgoPage ? NGO_IMAGES : IMAGES;
